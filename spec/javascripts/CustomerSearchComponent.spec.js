...
describe("CustomerSearchComponent", function() {
  ...
  describe("search", function() {
    describe("A search for 'pa', less than 3 chars", function() {
      var mockHttp = null;
      beforeEach(function() {
      ...
      it("doesn't make an HTTP call", function() {
        component.search("pa");
        td.verify(mockHttp.get(), { times: 0 });
      });
    });
    describe("A search for 'pat', 3 or more chars", function(){
      var mockHttp = null;
      var customers = [
        {
          id: 1,
      ...
      describe("A search that fails on the back-end", function() {
        ...
        it("alerts the user with the response messages", function() {
          component.search("pat");
